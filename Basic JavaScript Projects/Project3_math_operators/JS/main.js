...
function modulus_Operator() {
    var simple_Math = 25 % 6; // example of modulus
...
function negative_Operator() {
    var x = 10;
    document.getElementById("negative").innerHTML = -x + " is the negative version of " + x; // example of of negative values
}
...
function random_Number() {
    ...
    document.getElementById("random").innerHTML = "Here is a random number between 0 and 100: " + x; // example of random numbers
}